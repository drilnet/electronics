...
┌─[ +5В ]─────────────────────────────────────────────────┐
<br>
│          Напряжение на трансформаторе: 9 В              │
│                        Микросхема DA1: L7805CV, CHN, ST │
│                  Нагрузочный резистор: 8.2 Ом, 5 Вт     │
│                                   Ток: 0.6 А            │
│                          Время работы: 1 час            │
│            Температура радиатора RAD1: 40.6 °C          │
│    Температура пластины (VD1, KBU600): 48.5 °C          │
└─────────────────────────────────────────────────────────┘
