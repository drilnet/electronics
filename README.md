...
<br>
&nbsp;&nbsp;&nbsp;&bull; [Стабилизированный блок питания +9В/0.5А для TEA2025B](https://github.com/drilnet/electronics/tree/master/Power Supply +9V for TEA2025B "Трансформаторный (используется микросхема: L7809CV)")
<br>
